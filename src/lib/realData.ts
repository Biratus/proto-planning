...
import { Formateur, Module, SerializedModule } from "./types";
...
// const parsedModules: SerializedModule[] = [];

// for (let m of raw) {
//   parsedModules.push({
//     ...m,
//     filiere: { nom: m.filiere },
//     start: formatISO(parse(m.start, "M/d/yyyy")),
//     end: formatISO(parse(m.end, "M/d/yyyy")),
//   });
// }

// export const modules: SerializedModule[] = parsedModules;
...
//   return modules.filter((m) => m.filiere.nom == filiereId);
// }
